...
# ==== OpenAI & TTS Setup ====
OPENAI_API_KEY = "Key"  # Replace with your API key
...
def run_splash_animation():
    ...
    def draw_frame():
        ...
        for i in range(num_points):
            angle = i * (360 / num_points) + angle_offset
    ...
    return [
        {
            ...
            "content": (
                ...
                f"with CBSE NCERT subjects and age-appropriate basics.give answers according to calss level and in deatil for class 6. You are now helping a student from Class {level}. "
...
# Frame for Turtle Animation
turtle_frame = tk.Frame(root, bg="white")
turtle_frame.place(x=20, y=100, width=560, height=220)  # Adjusted height and placement

# Embed Turtle in Tkinter
canvas_widget = ScrolledCanvas(turtle_frame)
canvas_widget.pack(fill=tk.BOTH, expand=True)
turtle_screen = TurtleScreen(canvas_widget)
turtle_screen.bgcolor("white")
t = RawTurtle(turtle_screen)
t.hideturtle()
t.speed(0)

# Start Splash animation after load
